...
def lottery49():
    ...
    for i in target:
        list += i.text
    #return("49樂台彩 \n" + "開出順序: " + list[96:114] + "\n" + "大小順序: " + list[114:132])
    return list[96:114], list[114:132]
